...
import { User, Phone, Mail, Lock, Camera, Check, Loader2, Eye, EyeOff } from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-gray-200 py-2.5 pl-4 pr-11 outline-none transition-all focus:ring-2 focus:ring-primary-500"
